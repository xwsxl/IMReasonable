...
-(void)setMessage:(IMMessage *)message{
    NSString *emailJson=[message.body stringByReplacingOccurrencesOfString:@"'" withString:@"\""];
    
    
    SpreadMailModel *model=[SpreadMailModel mj_objectWithKeyValues:[emailJson stringByReplacingOccurrencesOfString:@"%quert%" withString:@"'"]];
    ...
    //添加小时和分钟
        ...
        NSString *H = [NSString stringWithFormat:@"%02ld", (long)[componentsH hour]];
        NSDateComponents *componentsM = [cal components:NSMinuteCalendarUnit fromDate:date];
        NSString *M = [NSString stringWithFormat:@"%02ld", (long)[componentsM minute]];

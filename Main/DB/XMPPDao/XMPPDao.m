...
{
    NSLog(@"tipservermessage:%@",message);
    ...
    [IMReasonableDao setUserUpdate:time user:fromjidstr];
    if (flag) {
...
- (void)sendChatMessage:(NSString*)fromjidstr type:(NSString*)type body:(NSString*)msg voicelenth:(NSString*)vl msgID:(NSString*)msgID
{
  ...
  //  NSLog(@"哈哈哈哈哈哈哈哈%@", message);
    [xmppStream sendElement:message];
    [IMReasonableDao setUser:fromjidstr msg:msgID];

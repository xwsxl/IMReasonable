...
- (NSString *)createRoom:(NSString *)roomname {
    
    XMPPJID *roomJID = [XMPPJID jidWithString:[NSString stringWithFormat:@"%@@muc.%@",roomname,XMPPSERVER]];
   // NSLog(@"xmppjid=%@,xmppjid.user=%@,xmppjid.domain=%@,xmppjid.resource=%@",roomJID,roomJID.user,roomJID.domain,roomJID.resource);
    ...
    NSString *roomjid=[NSString stringWithFormat:@"%@@%@",roomJID.user,roomJID.domain];
    return roomjid;
...
//    </message>
    [xmppRoom changeRoomSubject:roomjidstr];

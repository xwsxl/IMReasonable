...
//        self.backgroundImage.image=[bubble resizableImageWithCapInsets:UIEdgeInsetsMake(49, 97, 57, 118) resizingMode:UIImageResizingModeStretch];
        ...
        _voicetime.textColor = [UIColor grayColor];
        _voicetime.frame=CGRectMake(5, offset, 70, 30);
        _voiceAm.frame=CGRectMake(95, offset, 20, 20);
       ...
       _stateview.frame=CGRectMake(120-30, 40-15+offset-2, 25, 10);
    ...
    _voicetime.text=[NSString stringWithFormat:@"%@ \"",messagemode.content];
